...
(() => {
    ...
    let img = new Image;
    img.src = "https://raw.githubusercontent.com/Sh1N02/Blooket-Cheats/main/autoupdate/timestamps/gold/setGold.png?" + Date.now();
    ...
    img.onload = function() {
        ...
        if (parseInt(time) <= 1708817191572 || iframe.contentWindow.confirm(error)) cheat();
    }
